...
eval (Type.Int x) (LessOrEqual _ ) (Type.Real y) = Type.Bool (x <= y)
eval (Type.Real x) (LessOrEqual _ ) (Type.Int y) = Type.Bool (x <= y)
eval (Type.Int x) (GreaterOrEqual _ ) (Type.Int y) = Type.Bool (x >= y)
eval (Type.Real x) (GreaterOrEqual _ ) (Type.Real y) = Type.Bool (x >= y)
eval (Type.Int x) (GreaterOrEqual _ ) (Type.Real y) = Type.Bool (x >= y)
eval (Type.Real x) (GreaterOrEqual _ ) (Type.Int y) = Type.Bool (x >= y)
eval (Type.Int x) (Equal _ ) (Type.Int y) = Type.Bool (x == y)
eval (Type.Real x) (Equal _ ) (Type.Real y) = Type.Bool (x == y)
eval (Type.Int x) (Equal _ ) (Type.Real y) = Type.Bool (x == y)
eval (Type.Real x) (Equal _ ) (Type.Int y) = Type.Bool (x == y)
...
eval (Type.Int x) (NotEqual _ ) (Type.Real y) = Type.Bool (x != y)
eval (Type.Real x) (NotEqual _ ) (Type.Int y) = Type.Bool (x != y)
...
eval (Type.Int x) (Less _ ) (Type.Real y) = Type.Bool (x < y)
eval (Type.Real x) (Less _ ) (Type.Int y) = Type.Bool (x < y)
eval (Type.Int x) (Greater _ ) (Type.Int y) = Type.Bool (x > y)
eval (Type.Real x) (Greater _ ) (Type.Real y) = Type.Bool (x > y)
eval (Type.Int x) (Greater _ ) (Type.Real y) = Type.Bool (x > y)
eval (Type.Real x) (Greater _ ) (Type.Int y) = Type.Bool (x > y)
